...
IFontDisp = Font
__all__ = [ 'IFont', 'OLE_YSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'VgaColor', 'LoadPictureConstants', 'Color', 'FONTITALIC',
           'Picture', 'FONTUNDERSCORE', 'Font', 'FontEvents',
           'IPictureDisp', 'FONTBOLD', 'Unchecked', 'OLE_CANCELBOOL',
           'IPicture', 'OLE_COLOR', 'OLE_HANDLE', 'Default',
           'IFontDisp', 'OLE_XPOS_HIMETRIC', 'IFontEventsDisp',
           'OLE_YSIZE_HIMETRIC', 'StdFont', 'OLE_XPOS_CONTAINER',
           'FONTNAME', 'FONTSTRIKETHROUGH', 'OLE_TRISTATE',
           'StdPicture', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_HIMETRIC',
           'Checked', 'OLE_YSIZE_CONTAINER', 'OLE_OPTEXCLUSIVE',
           'Monochrome', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_HIMETRIC',
           'OLE_XPOS_PIXELS', 'Gray', 'OLE_YPOS_PIXELS']
